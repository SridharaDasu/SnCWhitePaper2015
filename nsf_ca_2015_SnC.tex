...
and storage to future years based expected LHC  luminosity plan 
(see Table~\ref{projection}), to define plans for the future.
...
We expect that the storage in full AOD format is limited to 10\% of
the data volume. 
...
as many U.S.~CMS institutions as possible by focussing on 25 institutions 
...
OSG on the detailed access mechanisms and policies.  
...
also inefficient.  It was also observed that much of the disk volume was
...
% \noindent{\bf Development if Multi-threaded CMSSW Applications}
