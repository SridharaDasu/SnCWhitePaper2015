...
\caption[]
{
Currently available and used number of job slots and storage (pb) are tabulated for the US Tier-2s.
}
...
\hline
&\multicolumn{2}{|c|}{ } &\multicolumn{4}{|c|}{\bf Total for US Tier-2s}&\multicolumn{2}{|c|}{\bf Per Tier-2} \\ \cline{4-9}
