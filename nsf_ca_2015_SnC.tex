...
%The current status of those and future plans regarding them are described in the subsections below.  
...
2 & Successfully operate multi-core scheduling at all Tier-2's at scale of pledged hardware to CMS\\
2 & Deployment and integration into production of the first ten ``Tier 3 in-a-box'' systems\\
...
4 & Design and integrate into production the next five most important improvements to support \\
...
5 & Meet software maintenance and support expectations agreed upon with global CMS \\
    & for the software supported via this award\\
